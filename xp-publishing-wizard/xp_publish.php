...
/**
  * XP Publishing wizard for ZenPhoto 0.4
  * Copyright (C) 2006 Niels Leenheer
  *
  * Inspired by the XP Publishing wizard from
  ...
  * support new Zenphoto installations 1.1.3 and greater and 
...
<?php		
	...
	function window.onload() {
		...
		window.external.SetWizardButtons(<?php echo $this->buttonsEnableBack ? 'true' : 'false'; ?>,<?php echo $this->buttonsEnableNext ? 'true' : 'false'; ?>,<?php echo $this->buttonsLastServerSidePage ? 'true' : 'false'; ?>);
	}
	...
	function send_reg_file() {
		...
		$lines[] = '[HKEY_CURRENT_USER\Software\Microsoft\Windows\CurrentVersion\Explorer\PublishingWizard\Providers\\'. getOption('gallery_title') .']';
		$lines[] = '"displayname"="' . getOption('gallery_title') . '"';
