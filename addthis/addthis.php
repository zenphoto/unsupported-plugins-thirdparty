...
function addthisJS() { 
	...
	<?php } ?>
	<script type="text/javascript" src="http://s7.addthis.com/js/300/addthis_widget.js<?php if ((getOption('addthis_profileID')) != '') {echo '#pubid='.getOption('addthis_profileID');} ?>"></script>
	<?php if (getOption('addthis_ga') != '') { ?>
	<script type="text/javascript">
		var _gaq = _gaq || [];
...
if ($style == '') $style = getOption('addthis_style');
